...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['project-manager', 'site-manager', 'construction-worker'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Material', path: '/materials', entity: 'material', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Site', path: '/sites', entity: 'site', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
